	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header">
			<div class="top_box">
		        ...
		        <div class="top_icon">
		        	<a href="${pageContext.request.contextPath}/ReturnTeacherIndex" title="首页"><img src="images/top_home.png"></a>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree"  lay-filter="test">
					...
					<li class="layui-nav-item">
						<a href="${pageContext.request.contextPath}/show_tt_score" target="main_self_frame"><i class="fa fa-shield fa-fw"></i>查看结果</a>
					</li>
					<li class="layui-nav-item">				
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="${pageContext.request.contextPath}/updateteacher_pwd" target="main_self_frame">修改密码</a></a>
						</dl>
