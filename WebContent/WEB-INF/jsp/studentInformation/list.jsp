            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="right">
                        ...
                        <input type="text" name="student_no"  value="${student.student_no}"  class="layui-input" disabled>
                    </div>
                </li>
                <li>
                    <div class="left">姓名：</div>
                    <div class="right">
                        <input type="text" name="student_name"  value="${student.student_name}"  class="layui-input">
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="right">
                        <input type="text" name="sex"  value="${student.sex}"  class="layui-input">
                    </div>
                </li>
                <li>
                    <div class="left">电话号码：</div>
                    <div class="right">
                        <input type="text" name="tel"  value="${student.tel}"  class="layui-input">
                    </div>
                </li>
                <li>
