    ...
    <table class="layui-table" lay-filter="mylist" lay-size="lg">
        <thead>
        	<tr>
            	...
            	<th lay-data="{field:'time',align:'center', minWidth:130}">院系</th>         	
            	<th lay-data="{field:'techer1', align:'center',minwidth:130}">评价教师</th>            	
            	<th lay-data="{field:'techer2', align:'center',minWidth:130}">被评价教师</th> 
            	<th lay-data="{field:'course——name', align:'center',minWidth:130}">课程名</th>      	
            	<th lay-data="{field:'www',align:'center',minWidth:100}">分数</th>             	                   
            	<th lay-data="{field:'option',align:'center',width:200,fixed: 'right'}">操作</th>
        	</tr>
        </thead>
        <tbody>
        <c:forEach items="${tt_scores}" var="item">
        	<tr>
            	<td></td>
            	<td>${item.id}</td>
	...
	function del(id){
		...
		layer.confirm('你确定要删除该信息吗？', {
		  btn: ['确定','取消'] //按钮
			...
			$.ajax({
				url:"${pageContext.request.contextPath}/deleteTt_scores?id="+id,
				async:false,
				type:"post",				
				dataType:"json",
